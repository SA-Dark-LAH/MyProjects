...
/*   Updated: 2024/11/27 12:33:45 by saharraz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

char	*line_finder(int fd, char *remain, char *buff)
{
	int		b_read;
	char	*line;
	char	*memo_holder;
...
char	*rest_for_next(char *current_line, char *remain)
{
	int		index ;
	char	*rest;
	int		i;
...
/*int main()
{
    ...
    {
        printf("%s", ptr); // Print the current line.
